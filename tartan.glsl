...
void main(void){
    ...
    st -= vec2(0.5);
    st += vec2(-0.21, -0.);
    st *= rotate2d(PI / (3.0 + sin(iGlobalTime)));
    // st *= rotate2d(PI / 4.0);
    st += vec2(0.5);

    const float lighten = 4.5;
    // thick black lines
    color -= vec3(box(st, vec2(0.2, 2.0), 0.01)) / lighten;
    color -= vec3(box(st + vec2(0.3, 0.0), vec2(0.2, 2.0), 0.01)) / lighten;
    color -= vec3(box(st, vec2(2.0, 0.2), 0.01)) / lighten;
    color -= vec3(box(st + vec2(0.0, 0.3), vec2(2.0, 0.2), 0.01)) / lighten;

    // thin light lines
    color += vec3(box(st + vec2(0.3, 0.0), vec2(0.01, 2.0), 0.01)) / 1.5;
    ...
    color.rg += vec2(box(st + vec2(0.0, -0.03), vec2(2.0, 0.01), 0.01)) / 2.5;
    color.rg += vec2(box(st + vec2(0.0, 0.33), vec2(2.0, 0.01), 0.01)) / 2.5;
    
    // thin vertical lines
    color -= vec3(box(st + vec2(-0.25, 0.0), vec2(0.02, 2.0), 0.01)) / lighten;
    color -= vec3(box(st + vec2(0.457, 0.0), vec2(0.02, 2.0), 0.01)) / lighten;
    color += vec3(box(st + vec2(-0.18, 0.0), vec2(0.02, 2.0), 0.01)) / 2.5;
    color += vec3(box(st + vec2(0.527, 0.0), vec2(0.02, 2.0), 0.01)) / 2.5;
    ...
    color += vec3(box(st + vec2(0.0, -0.18), vec2(2.0, 0.02), 0.01)) / 2.5;
    color += vec3(box(st + vec2(0.0, 0.527), vec2(2.0, 0.02), 0.01)) / 2.5;
